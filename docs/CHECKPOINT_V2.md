...
- **Cycle time**: A's median is 15 simulated business days, not the case's 26, because four of the twelve (three clean PO invoices and the credit note) are posted by AP in 2 days; a non-PO invoice sent to a store takes 25 (Assumptions, section 6). B's median is 0 because 8 of 11 posted invoices are posted the day they arrive; the deck's target of 3 days is a steady-state figure.
- **First-pass match in B** is 72.7%, below the deck's 90% target: three of the eleven invoices are designed to need a person (B-01, B-05, B-06). Card / catalogue counts as a commitment (brief v2 section 1); deck A6 names PO and contract.
